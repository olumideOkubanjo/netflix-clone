...
interface Props {
    // Add ? to the end of the name to make this an optional attribute
...
const Banner = ({ netflixOriginals }: Props) => {
    ...
    useEffect(() => {
        setMovie(
            // Generate random index, so we start with a different movie when the component did mount
            netflixOriginals[
